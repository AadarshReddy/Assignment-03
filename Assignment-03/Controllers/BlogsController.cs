...
namespace Assignment_03.Controllers
{
    public class BlogsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BId,BTitle,BContent,PDate,BAuthor")] Blogs blogs)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BId,BTitle,BContent,PDate,BAuthor")] Blogs blogs)
        {
            if (ModelState.IsValid)
            {
